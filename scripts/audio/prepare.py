...
SFX = {
 ...
 'treeGrow': ('digital-audio','powerUp5'), 'slotLever': ('interface-sounds','switch_006'),
 'slotTick': ('interface-sounds','tick_002'), 'slotStop': ('casino-audio','chip-lay-1'),
 'slotThud': ('digital-audio','lowDown'), 'slotWinSmall': ('digital-audio','twoTone2'),
 'slotWinMid': ('digital-audio','threeTone2'), 'slotWinBig': ('music-jingles','jingles_NES03'),
