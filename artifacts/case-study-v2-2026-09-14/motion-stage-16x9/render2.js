...
(async()=>{
 ...
 await pg.goto('file://'+path.join(__dirname,(process.env.STAGE||'stage2.html'))); await pg.waitForFunction('window.__ready===true'); await pg.evaluate(()=>document.fonts.ready);
