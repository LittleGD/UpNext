...
• 직업 스킬이 두 갈래로 나뉘고 300코인으로 다시 찍을 수 있어요. 스킬 포인트는 영웅 레벨 30부터 매 레벨 1개.
...
• 2인 불꽃 초대 링크를 공유할 수 있어요. 친구가 링크를 누르면 앱에서 바로 합류합니다.
...
• Class skills branch two ways, and a respec costs 300 coins. Skill points arrive one per hero level from level 30.
...
• Share a Duo Flame invite link. When a friend taps it, they join right in the app.
...
• 職業スキルが二つの分岐に分かれ、300コインで振り直せます。スキルポイントは英雄レベル30から1レベルごとに1つ。
...
• 2人の炎の招待リンクを共有できます。友だちがリンクをタップすると、アプリですぐに参加できます。
...
• 职业技能分成两条分支，花300金币可以重置。技能点从英雄30级起每升一级得1点。
...
• 修复了返回应用后音效无法播放的问题。
• 可以分享双人火焰邀请链接。朋友点击链接后即可在应用内直接加入。
