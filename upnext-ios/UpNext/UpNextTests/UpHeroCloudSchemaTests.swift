...
//
//  2026-09-04 갱신 — 격자 가방 좌표(bagX/bagY/bagRot)를 인벤 두 원소에 실었다.
//  이 키들은 화이트리스트라, iOS 가 하나라도 빠뜨리면 웹이 저장한 가방 배치가
//  왕복 한 번에 통째로 지워진다 (플랜 ultracode-adaptive-scroll 의 릴리스 순서 위험).
//
