...
import { MAX_ENHANCE_LEVEL, type Equipment } from "@/types/uphero";
import { GB, GB_LEGEND, GB_RARITY_GLOW, EASE_OUT, gbClass } from "@/lib/upHeroPalette";
          ...
          return (
            <button
              ...
              style={{
                ...
                opacity: lift?.item.id === item.id ? 0.35 : 1,
              }}
            >
              {item.photoId ? (
                <EquipmentPhotoThumb
                  ...
                  style={{
                    ...
                    background:
                      enhance >= MAX_ENHANCE_LEVEL
                        ...
                        : `${GB.darkest}dd`,
                    color:
                      enhance >= MAX_ENHANCE_LEVEL ? GB.darkest : GB.lightest,
                  }}
                >
                  +{enhance}
                </span>
